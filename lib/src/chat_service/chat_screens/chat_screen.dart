...
class ChatScreenController extends GetxController {
  ...
  Future<void> scrollToMessage(int targetMessageId) async {
    ...
    if (index != -1) {
      await scrollCtrl.scrollToIndex(
        index,
  ...
  Future<void> _uploadAndSend(File file, String type) async {
    ...
    String? url = await globalController.uploadFile(
      file,
      onProgress: (val) {
  ...
  void fetchGroupMembers() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // شمارش آنلاین‌ها
        onlineCount.value = members.where((u) => u.isOnline).length;
      }
    } catch (e) {
  ...
  Future<void> toggleBlock() async {
    ...
    if (success) {
      ...
      Get.snackbar(
        "موفق",
        isBlocked.value ? "کاربر مسدود شد" : "کاربر رفع مسدودیت شد",
      );
    }
  }
  ...
  void listenToSocket() {
    ...
    _typingWorker = ever(socketService.typingStatus, (
  ...
  void sendMessage({
    ...
    // B. ارسال پیام جدید
    final tempId = DateTime.now().millisecondsSinceEpoch; // آیدی موقت
  ...
  List<ChatUser> getPotentialMembers() {
    ...
    return globalController.allUsers
                ...
                child: Obx(() {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (ctx, index) {
                      ...
                      final currentUserId =
                          controller.globalController.currentUserId ?? 0;
                ...
                return Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      const Spacer(),
                      Text(
                        "${(controller.uploadingFiles.values.first * 100).toInt()}%",
                        style: const TextStyle(
                          fontSize: 12,
                          fontWeight: FontWeight.bold,
                        ),
                ...
                return SizedBox(
                  ...
                  child: EmojiPicker(
                    ...
                    onBackspacePressed: () {
                      // پیاده‌سازی بک‌اسپیس
                      controller.textCtrl
                        ..text = controller.textCtrl.text.characters
                            .skipLast(1)
                            .toString()
            ...
            if (controller.userAvatar.value != null)
              ClipRRect(
                ...
                child: FastCachedImage(
                  url: controller.userAvatar.value!,
                  width: 100,
                  height: 100,
                  fit: BoxFit.cover,
                ),
      ...
      title: Obx(() {
        ...
        return InkWell(
          ...
          child: Row(
            children: [
              Hero(
                tag: "avatar_${controller.targetId}",
                child: Container(
                  decoration: BoxDecoration(
                    ...
                    child: controller.userAvatar.value == null
                        ? Text(
                            controller.userFullName.value.isNotEmpty
                                ? controller.userFullName.value[0]
                                : "?",
                            style: TextStyle(
                              color: color,
                              fontWeight: FontWeight.bold,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (controller.isTyping.value)
                      ...
                      Text(
                        "${controller.groupMembers.length} Member",
                        style: TextStyle(
        ...
        Obx(() {
          ...
          if (controller.isSearching.value) {
            return Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                if (controller.searchResultsIds.isNotEmpty)
                  Text(
                    "${controller.currentSearchIndex.value + 1} from ${controller.searchResultsIds.length}",
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 2),
                Text(
                  controller.replyMessage.value?.content ?? "File",
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis,
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (ctx, index) {
                    ...
                    return ListTile(
                      ...
                      subtitle: Text(
                        member.isOnline ? "Online" : "last visit...",
                      ),

                      // --- دکمه حذف (فقط اگر من ادمینم و طرف مقابل خودم نیستم) ---
                      trailing: (amIAdmin && !isMe)
                          ? IconButton(
                              icon: const Icon(
...
class _AdvancedVoicePlayerState extends State<_AdvancedVoicePlayer> {
  ...
  Future<void> _loadSavedSpeed() async {
    final savedSpeed =
        await PrefHelpers.getVoiceSpeed(); // فرض بر این است که این متد String یا Double برمی‌گرداند
    if (savedSpeed != null) {
      setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      height: 45,
      child: Row(
        // نکته: mainAxisSize: MainAxisSize.min را حذف کردیم
        ...
        children: [
          ...
          Expanded(
            child: AudioFileWaveforms(
              // size را روی infinity نگذارید چون داخل row است، اما چون Expanded دارد مشکلی نیست
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Text(
                "${playbackSpeed.toString().replaceAll('.0', '')}x",
                style: TextStyle(
                  fontSize: 10,
                  fontWeight: FontWeight.bold,
                  color: widget.isMe ? Colors.white : Colors.black87,
...
class _ModernMessageBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final sentGradient = LinearGradient(
      colors: [const Color(0xff969bff),const Color(0xff969bff), ColorsHelper.btn2],
    );
                            ...
                            if (message.parent != null)
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child: Text(
                                    message.parent!.content.isNotEmpty
                              ...
                              GestureDetector(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: ConstrainedBox(
                                    // محدودیت ارتفاع و عرض برای جلوگیری از کرش
                                    constraints: BoxConstraints(
                                      maxHeight:
                                          400, // جلوگیری از عکس‌های خیلی دراز
                                      minWidth:
                                          Get.width *
            ...
            child: Column(
              ...
              children: [
                ...
                _buildPopupMenuItem(
                  ...
                  onTap: () => controller.pinMessage(
                    msg.id!,
                  ), // بستن دیالوگ داخل کنترلر هندل شده
                ),
                    ...
                    onTap: () {
                      ...
                      Get.defaultDialog(
                        ...
                        onConfirm: () {
                          ...
                          controller.globalController.deleteMessageForEveryone(
                            msg.id!,
                          );
                        },
                      );
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (ctx, i) {
                    return ListTile(
                      ...
                      onTap: () =>
                          controller.forwardMessage(msgId, users[i].id),
                    );
                  },
                );
              }),
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  ...
                  const SizedBox(width: 8),
                  Expanded(
                    // اینجا می‌توانید از PlayerController دوم برای پخش استفاده کنید
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Obx(
            () => Text(
              "${(controller.recordDuration.value ~/ 60).toString().padLeft(2, '0')}:${(controller.recordDuration.value % 60).toString().padLeft(2, '0')}",
          ...
          GestureDetector(
            onTap: () => controller.stopForReview(),
            child: CircleAvatar(
              radius: 22,
              backgroundColor: primaryColor,
          ...
          children: [
            Center(
              child: _controller.value.isInitialized
                  ...
                  : const CircularProgressIndicator(color: Color(0xff969bff)),
            ),
